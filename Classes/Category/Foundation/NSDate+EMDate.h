...
/**
 月份的天数
 */
@property (nonatomic, assign, readonly) NSInteger em_daysOfMonth;
...
/**
 是否今年
 */
@property (nonatomic, assign, readonly) BOOL em_isThisYear;
...
/**
 ...
 @return YES/NO
 */
+ (BOOL)em_compareIsOneDate:(nullable NSDate *)date1
                anotherDate:(nullable NSDate *)date2;
...
/**
 ...
 @return 转化后的NSDate
 */
+ (nullable NSDate *)em_dateWithIntervel:(NSTimeInterval)interval;
