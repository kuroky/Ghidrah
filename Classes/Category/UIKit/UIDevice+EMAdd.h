...
/**
 屏幕宽度
 */
@property (assign, nonatomic, readonly) CGFloat em_width;

/**
 屏幕高度
 */
@property (assign, nonatomic, readonly) CGFloat em_height;

/**
 是否全面屏
 */
@property (nonatomic, assign, readonly) BOOL em_isFullScreen;
