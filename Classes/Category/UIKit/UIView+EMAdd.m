...
//MARK:- 绘制虚线
+ (nonnull CAShapeLayer *)em_drawImaginaryLine:(CGRect)bounds {
    CAShapeLayer *shapeLayer = [CAShapeLayer layer];
    shapeLayer.frame = CGRectMake(0, CGRectGetHeight(bounds) * 0.5, CGRectGetWidth(bounds), 1);
    [shapeLayer setFillColor:[UIColor clearColor].CGColor];
    [shapeLayer setStrokeColor:[UIColor colorWithRed:210.0/255 green:210.0/255 blue:214.0/255 alpha:1.0].CGColor]; // 颜色
    [shapeLayer setLineWidth:0.5]; // 宽度
    [shapeLayer setLineJoin:kCALineJoinRound];
    [shapeLayer setLineDashPattern:@[@2, @2]]; // 线宽，线间距
    // 路径
